...
.then(response => {
  ...
  let subject = `I found your ${response.data[0].product_name} product on ProductHero!`
  let body = `Dear ProductHero user, your product ${response.data[0].product_name} was found on ProductHero!
  Here it is: (please list the URL or store where the product was located)
